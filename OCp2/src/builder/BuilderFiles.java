...
/**
 * <b>BuilderFile is the abstract class that allows you to build, display and
 * save a file.</b>
 * <p>
...
public abstract class BuilderFiles {
	...
	/**
	 * <b>abstract void print() display a file according to the type of constructor
	 * used<b>
	 * 
	 */
	...
	/**
	 * <b>abstract void save() saves a file according to the type of constructor
	 * used<b>
	 * 
	 */
